...
namespace ID3Sharp
{
	...
	public class ID3v2Tag : ID3Tag
	{
		...
		/// <param name="filename">The name of the file to read.</param>
		/// <returns>The tag read from the file, or null if no ID3v2 tag was present.</returns>
		public static ID3v2Tag ReadTag( string filename , Encoding encoding)
		{
			using( Stream stream = new FileStream( filename, FileMode.Open, FileAccess.Read ) )
			{
		...
		public static ID3v2Tag ReadTag( Stream stream, Encoding  encoding)
		{
            ID3Versions version = LookForTag(stream);
            ID3v2Tag tag = null;
            ...
            if ((version & ID3Versions.V2) == ID3Versions.V2)
            {
                ...
                {
                    ID3v2Frame newFrame = ID3v2Frame.ReadFrame(stream, version, encoding);
                    if (newFrame != null)
                    {
