...
namespace ID3Sharp
{
	...
	public abstract class ID3v2Frame
	{
		...
		/// <param name="frameData">The raw frame data.</param>
		/// <param name="version">The ID3 version of the tag being parsed.</param>
		protected virtual void ParseFrameData( byte[] frameData, ID3Versions version, Encoding encoding)
		{
		...
		/// <param name="frameData">The raw data in the frame's data section.</param>
		/// <param name="version">The ID3v2 version of the tag being parsed.</param>
		public virtual void Initialize( byte[] flags, byte[] frameData, ID3Versions version, Encoding encoding)
		{
			ParseFlags( flags, version );
            ParseFrameData(frameData, version, encoding);
		}
		#endregion
		...
		/// <param name="version">The ID3v2 version of the tag being parsed.</param>
		/// <returns>The frame read from the stream.</returns>
		public static ID3v2Frame ReadFrame( Stream stream, ID3Versions version, Encoding encoding)
		{
			if ( stream == null )
			{
				throw new ArgumentNullException( "stream" );
			...
			if ( idChars[0] != 0x0 )
			{
				...
				frame.Initialize( flags, frameData, version, encoding );
			}
			else
			{
				frame = null;
